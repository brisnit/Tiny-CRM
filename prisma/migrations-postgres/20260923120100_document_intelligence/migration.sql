...
-- AddForeignKey
ALTER TABLE "DocumentIngestion" ADD CONSTRAINT "DocumentIngestion_fileAssetId_workspaceId_fkey" FOREIGN KEY ("fileAssetId", "workspaceId") REFERENCES "FileAsset"("id", "workspaceId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentChunk" ADD CONSTRAINT "DocumentChunk_ingestionId_fileAssetId_workspaceId_fkey" FOREIGN KEY ("ingestionId", "fileAssetId", "workspaceId") REFERENCES "DocumentIngestion"("id", "fileAssetId", "workspaceId") ON DELETE CASCADE ON UPDATE CASCADE;
